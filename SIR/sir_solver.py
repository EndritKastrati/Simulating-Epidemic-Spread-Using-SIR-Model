from adaptive_rk_solver import rkf45
...
def solve_sir(S0, I0, R0, beta, gamma, t_max, tol):
    ...
    try:
        results = rkf45(sir_derivatives, y0, t_max, tol, params)
        print(f"Results from rkf45: {results[:10]}")  # Check first 10 results
        if results.shape[0] == 0:
            raise ValueError("Empty results from RKF45.")
        return results
    ...
    return implicit_rk(sir_derivatives, y0, t_max, tol, params)
